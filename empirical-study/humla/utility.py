# Utility functions/variables for this project.
import numpy as np
import numbers
import pandas as pd
import os
...
def load_para_csv():
    # load the para_csv to the local memory to enable multiprocessing. 2022/11/9
    csv_dir = "humla/data_stream/"
    para_csv = pd.read_csv(csv_dir + 'para_bst_30sd_p2000-ijcnn22-save.csv')
    return para_csv
...
def delete_invalid_folders(post_fix="careful"):
    ...
    TC on 2022/12/1/ and Liyan updated.
    """
